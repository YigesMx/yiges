...
- [MiTeX Typsy Repo](https://typst.app/universe/package/mitex/) - [:material-github: Repo](https://github.com/mitex-rs/mitex)

然后，还有我们的万能工具 [Pandoc](https://pandoc.org/)，可以实现 Markdown、LaTeX、Typst 之间的相互转换，虽然某些格式他们相互之间的转换可能会有一些损失，但是公式的转换还是没有问题的。
